...
from kfq6bnwweuguwvzqikb6ag_.tasks import DBT_0, DBT_0_1, Email_2, HTTPSensor_1, S3FileSensor_1, Slack_1
PROPHECY_RELEASE_TAG = "__PROJECT_ID_PLACEHOLDER__/__PROJECT_RELEASE_VERSION_PLACEHOLDER__"

with DAG(
    dag_id = "kfq6bNwWeuguWvzqikb6Ag_", 
    ...
    start_date = pendulum.datetime(2023, 10, 3, tz = "UTC"), 
