def DBT_0_1():
    ...
    return BashOperator(
        task_id = "DBT_0_1",
        bash_command = f"$PROPHECY_HOME/run_dbt.sh \"dbt deps --profile run_profile; dbt seed --profile run_profile --threads=2; dbt run --profile run_profile --threads=2; dbt test --profile run_profile --threads=2; \"",
        env = envs,
        append_env = True,
