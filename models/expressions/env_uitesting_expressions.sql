...
OrderBy_1 AS (
  ...
  ORDER BY customer_id DESC NULLS LAST, CAST(customer_id AS int) > 5 ASC NULLS FIRST, CAST(customer_id AS int) != 0 ASC NULLS FIRST
...
SQLStatement_2 AS (
  ...
  SELECT 
    ...
    (to_char(DATE'2016-04-08', 'y') != NULL),
    (to_char(encode('abc', 'utf-8'), 'utf-8') != NULL),
    (to_varchar(454, '999') != NULL),
    (to_varchar(DATE'2016-04-08', 'y') != NULL),
    (to_varchar(x'537061726b2053514c', 'hex') != NULL),
    (TRIM( 'SL' FROM 'SSparkSQLS') != NULL),
    (TRIM(BOTH 'SL' FROM 'SSparkSQLS') != NULL),
    (TRIM(LEADING 'SL' FROM 'SSparkSQLS') != NULL),
    (TRIM(TRAILING 'SL' FROM 'SSparkSQLS') != NULL),
    (
      CAST(try_aes_decrypt(
        unbase64('MTIzNDU2Nzg5MDEyMdXvR41sJqwZ6hnTU8FRTTtXbL8yeChIZA=='), 
        '1234567890abcdef', 
    ...
    (now() != NULL),
    (timediff(MONTH, TIMESTAMP'2021-02-28 12:00:00', TIMESTAMP'2021-03-28 12:00:00') == 1),
    (timestampdiff(MONTH, TIMESTAMP'2021-02-28 12:00:00', TIMESTAMP'2021-03-28 12:00:00') == 1),
    (to_unix_timestamp('2016-04-08', 'yyyy-MM-dd') == 100),
    ...
    (is_member('admins')),
    (luhn_check('12345') == NULL),
    (user() != NULL),
    (h3_coverash3('POLYGON((-122.4194 37.7749,-118.2437 34.0522,-74.0060 40.7128,-122.4194 37.7749))', 0) != NULL),
    (h3_coverash3string('{"type":"LineString","coordinates":[[-122.4194,37.7749],[-118.2437,34.0522],[-74.0060,40.7128]]}', 1) != NULL),
    (h3_longlatash3(-122.4783, 37.8199, 13) > 0),
    (h3_longlatash3string(-122.4783, 37.8199, 13) != NULL),
    (h3_pointash3('POINT(-122.4783 37.8199)', 13) > 0),
    (h3_pointash3string('{"type":"Point","coordinates":[]}', 15) == NULL),
    (h3_pointash3string('POINT(-122.4783 37.8199)', 13) != NULL),
    (
      h3_polyfillash3(
        unhex(
          '0103000000010000000400000050fc1873d79a5ec0d0d556ec2fe342404182e2c7988f5dc0f46c567dae064140aaf1d24d628052c05e4bc8073d5b444050fc1873d79a5ec0d0d556ec2fe34240'), 
    ...
    (h3_polyfillash3('POLYGON((-122.4194 37.7749,-118.2437 34.0522,-74.0060 40.7128,-122.4194 37.7749))', 2) != NULL),
    (h3_polyfillash3string('POLYGON((-122.4194 37.7749,-118.2437 34.0522,-74.0060 40.7128,-122.4194 37.7749))', 2) != NULL),
    (h3_try_polyfillash3('Not-a-valid-rep', 2) == NULL),
    (h3_try_polyfillash3('POLYGON((-122.4194 37.7749,-118.2437 34.0522,-74.0060 40.7128,-122.4194 37.7749))', 2) != NULL),
    (h3_try_polyfillash3string('POLYGON((-122.4194 37.7749,-118.2437 34.0522,-74.0060 40.7128,-122.4194 37.7749))', 2) != NULL),
    (h3_boundaryasgeojson('8009fffffffffff') != NULL),
    (h3_boundaryasgeojson(599686042433355775) != NULL),
    (hex(h3_boundaryaswkb(599686042433355775)) != NULL),
    (h3_boundaryaswkt(599686042433355775) != NULL),
    (h3_centerasgeojson(599686042433355775) != NULL),
    (hex(h3_centeraswkb('8009fffffffffff')) == NULL),
    (h3_centeraswkt('8009fffffffffff') != NULL),
    (h3_h3tostring(599686042433355775) != NULL),
    (h3_stringtoh3('85283473fffffff') == NULL),
    (h3_ischildof('88283471b9fffff', '85283473fffffff')),
    (h3_ispentagon(590112357393367039)),
    (h3_isvalid('85283473fffffff')),
    (h3_try_validate(590112357393367039) != NULL),
    (h3_validate(590112357393367039) != NULL),
    (h3_distance(599686030622195711, 599686015589810175) == 2),
    (h3_hexring(599686042433355775, 1) != NULL),
    (h3_kring(599686042433355775, 1) != NULL),
    (h3_kringdistances(599686042433355775, 1) != NULL),
    (h3_distance(599686030622195711, 599686015589810175) == 2),
    (h3_maxchild(599686042433355775, 10) != NULL),
    (h3_minchild(599686042433355775, 10) != NULL),
    (h3_resolution(599686042433355775) == 5) AS d6,
    (h3_tochildren(599686042433355775, 6) != NULL),
    (h3_toparent(599686042433355775, 0) != NULL),
    (
      h3_compact(
        ARRAY(
          599686042433355775, 
